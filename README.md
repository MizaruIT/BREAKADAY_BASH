...
[4] Option 04: Searching for IP vulnerable to MS08-067... [!! THIS OPTION IS SHOWN BUT WILL NOT BE EXECUTED EXCEPT IF YOU UNCOMMENT THE PART BC THIS ATTACK CAN BE HURTFUL]
[5] Option 05: Searching for IP vulnerable to PetitPotam with null session attack
[6] Option 06: Searching for IP vulnerable to SMB Signing attack
...
[4] Option 4: Add a Domain Controller (DC) ip and name
[5] Option 5: Add domain infos
[6] Option 6: Return to the main menu</pre>
		</details>
		<details>
		...
		<pre>[1] Option 1: Remove a local user
[2] Option 2: Remove a local administrator user
[3] Option 3: Remove a domain user
[4] Option 4: Remove a Domain Controller (DC) ip and name
[5] Option 5: Remove domain infos
[6] Option 6: Return to the main menu</pre>
		</details>
	</ol>
</details>
